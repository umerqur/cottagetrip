  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-sm text-[#6B5C4D]">
        A receipt is required for expense tracking. Upload a photo or PDF to add this expense.
      </p>
      ...
      {selectedFile ? (
        ...
        <label className="flex flex-col items-center justify-center w-full h-48 border-2 border-dashed border-[rgba(47,36,26,0.2)] rounded-lg cursor-pointer bg-[#FAFAF9] hover:bg-gray-100 transition">
          <div className="flex flex-col items-center justify-center pt-5 pb-6">
            <svg className="w-12 h-12 mb-3 text-[#6B5C4D]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
            </svg>
            <p className="mb-2 text-sm text-[#2F241A]">
              <span className="font-semibold">Click to upload</span> or drag and drop
            </p>
            <p className="text-xs text-[#6B5C4D]">PNG, JPG, PDF, HEIC (max 10MB)</p>
          </div>
          <input
            type="file"
            className="hidden"
